...
mkdir -p $OUTPUT
MATRIXOUT=$OUTPUT/${SUB}_${SES}_HCPMMP_FC_matrix.csv
LOGNAME=$OUTPUT/${SUB}_${SES}_hcpmmp

NODES=$CUSTOMDWI/output/tractography/${SUB}/${SUB}_${DWISES}_aparc.HCPMMP1+aseg_nodes_T1w.nii.gz
NODELIST=$CUSTOMDWI/hcpmmp1_atlas/hcpmmp1_ordered.txt
